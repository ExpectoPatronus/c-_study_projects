...
* Реализовать in-memory key-value хранилище на основе хеш-таблицы 
* Реализовать in-memory key-value хранилище на основе самобалансирующегося бинарного дерева поиска (выполнено [kang-bird](https://github.com/kang-bird))
* Реализовать консольный интерфейс
* Исследование временных характеристик работы хэш-таблиц и бинарного дерева
